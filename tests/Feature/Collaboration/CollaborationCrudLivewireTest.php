...
test('collaborator with edit permission can remove other collaborator on task', function (): void {
    $task = Task::factory()->for($this->owner)->create();
...
test('collaborator with edit permission can update collaborator permission on task', function (): void {
    $task = Task::factory()->for($this->owner)->create();
    Collaboration::create([
        'collaboratable_type' => Task::class,
        'collaboratable_id' => $task->id,
