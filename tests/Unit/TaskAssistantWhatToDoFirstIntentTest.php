...
test('matches what task should i do first and classic prioritize first phrases', function (): void {
    ...
    expect(TaskAssistantWhatToDoFirstIntent::matches('What should I tackle first today?'))->toBeTrue();
...
test('implies multiple prioritized rows without bare do first substring', function (): void {
    ...
    expect(TaskAssistantWhatToDoFirstIntent::impliesMultiplePrioritizedRows('what are my tasks for today'))->toBeTrue();
