            ...
            <div class="flex flex-col items-center">
                ...
                <div class="grid grid-cols-2 gap-2">
                    <button
                        ...
                        :class="type === 'daily' ? 'border-amber-200/55 bg-yellow-50 text-stone-600 dark:border-amber-900/20 dark:bg-yellow-950/12 dark:text-stone-400' : 'border-border bg-muted/50 hover:bg-muted'"
                    >
                        {{ __('Daily') }}
                    </button>
                    <button
                        ...
                        class="rounded-md border px-3 py-2 text-sm transition-colors"
                        :class="type === 'weekly' ? 'border-amber-200/55 bg-yellow-50 text-stone-600 dark:border-amber-900/20 dark:bg-yellow-950/12 dark:text-stone-400' : 'border-border bg-muted/50 hover:bg-muted'"
                    >
                        {{ __('Weekly') }}
                    </button>
                    <button
                        ...
                        class="rounded-md border px-3 py-2 text-sm transition-colors"
                        :class="type === 'monthly' ? 'border-amber-200/55 bg-yellow-50 text-stone-600 dark:border-amber-900/20 dark:bg-yellow-950/12 dark:text-stone-400' : 'border-border bg-muted/50 hover:bg-muted'"
                    >
                        {{ __('Monthly') }}
                    </button>
                    <button
                        ...
                        class="rounded-md border px-3 py-2 text-sm transition-colors"
                        :class="type === 'yearly' ? 'border-amber-200/55 bg-yellow-50 text-stone-600 dark:border-amber-900/20 dark:bg-yellow-950/12 dark:text-stone-400' : 'border-border bg-muted/50 hover:bg-muted'"
                    >
                        {{ __('Yearly') }}
                    </button>
                </div>
                    ...
                    <div class="grid grid-cols-7 gap-1.5">
                        <template x-for="(dayLabel, index) in dayLabels" :key="index">
                            <button
                                ...
                                :class="isDaySelected(index) ? 'border-amber-200/55 bg-yellow-50 text-stone-600 dark:border-amber-900/20 dark:bg-yellow-950/12 dark:text-stone-400 font-semibold' : 'border-border bg-muted/50 hover:bg-muted'"
                                x-text="dayLabel"
                            ></button>
                        </template>
                    </div>
