...
class ScheduleTasksPrompt extends AbstractLlmPromptTemplate
{
    public function systemPrompt(): string
    {
        return 'You are a scheduling assistant helping a student plan a short time window using multiple existing tasks. Keep the tone warm, practical, and conversational. '
            ...
            .'Count rule: If Context contains 2+ tasks, you MUST return at least 2 scheduled_tasks items (unless the user\'s time window or focused-work cap makes that impossible). If the user caps focused work at ~3 hours, the plan should usually include ~3–4 tasks (plus breaks/buffers) depending on durations. '
