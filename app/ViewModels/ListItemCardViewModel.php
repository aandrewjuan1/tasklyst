...
class ListItemCardViewModel
{
    ...
    public function alpineConfig(): array
    {
        ...
        return [
            ...
            'taskStatusOptions' => $kind === 'task' ? ($data['statusOptions'] ?? []) : null,
            'taskPriority' => $kind === 'task' ? ($item->priority?->value ?? null) : null,
            'taskComplexity' => $kind === 'task' ? ($item->complexity?->value ?? null) : null,
