...
class SchoolClassEndingSoonNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase(object $notifiable): array
    {
        $message = $this->offsetMinutes !== null && $this->offsetMinutes > 0
            ? __('Class ends in :minutes min: :title', ['minutes' => $this->offsetMinutes, 'title' => '“'.$this->subjectName.'”'])
            : __('Class ending soon: :title', ['title' => '“'.$this->subjectName.'”']);
        ...
        return [
            'type' => 'school_class_ending_soon',
            'title' => __('Class ending soon'),
            'message' => $message,
            'entity' => [
                'kind' => 'schoolClass',
