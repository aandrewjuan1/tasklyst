...
class SchoolClassNowLiveNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase(object $notifiable): array
    {
        ...
        return [
            'type' => 'school_class_now_live',
            'title' => __('Class is live'),
            'message' => __('Class in progress: :title', ['title' => '“'.$this->subjectName.'”']),
            'entity' => [
                'kind' => 'schoolClass',
